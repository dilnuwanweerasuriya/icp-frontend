                ...
                <div className="relative bg-gradient-to-br from-white to-gray-50">
                    ...
                    <div className="p-6 max-h-[calc(95vh-180px)] overflow-y-auto">
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                            ...
                            <div className="lg:col-span-2 space-y-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full px-4 py-2.5 rounded-xl border-2 border-gray-200 focus:border-accent focus:outline-none transition-all bg-white font-medium"
                                            >
                                ...
                                {/* Admin Notes */}
                                <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                                    <h3 className="text-lg font-bold mb-3 text-gray-800">Additional Notes</h3>
                                    <textarea
                                        className="w-full p-4 rounded-xl border-2 border-gray-200 focus:border-accent focus:outline-none resize-none transition-all"
                    ...
                    <div className="border-t border-gray-200 p-6 bg-white rounded-b-3xl">
                        <div className="flex gap-3 justify-end">
                            <button
                                onClick={() => setIsModalOpen(false)}
                                className="px-6 py-3 bg-gray-100 text-gray-700 rounded-xl cursor-pointer hover:bg-gray-200 transition-all font-semibold"
                            >
                                Cancel
                            </button>
                            {
                                (order.notes !== adminNotes || order.status !== status) && (
                                    <button
                                        onClick={handleSave}
                                        disabled={isSaving}
                                        className="px-8 py-3 bg-gradient-to-r from-accent to-accent/80 text-white rounded-xl hover:shadow-lg transition-all font-semibold flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                                    >
                                        {isSaving ? (
                                            <>
