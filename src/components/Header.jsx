...
export default function Header() {
    ...
    return (
        <div className='w-full h-[80px] md:h-[100px] bg-accent flex justify-between items-center px-4 md:px-6 relative'>
            ...
            {/* Desktop Navigation */}
            <div className='hidden md:flex w-full h-full text-lg lg:text-xl text-primary justify-center items-center gap-[20px] lg:gap-[30px]'>
            ...
            <div className='hidden md:flex w-full h-full text-lg lg:text-xl text-primary justify-end items-center gap-[20px] lg:gap-[30px] ml-auto'>
            ...
            <div className={`absolute z-9999 top-[80px] left-0 w-full bg-accent md:hidden transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0 overflow-hidden'
                }`}>
